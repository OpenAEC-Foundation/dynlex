...
| `src/brep/sweep.rs` | `cadkernel::brep::sweep` | 3802 | 4602 | 35 | in-progress | `brep_sweep.dl`; closed/open extrusion, revolution and tapered polygon/circle cases pass native O0/O2 fixtures; circular draft retains an analytic cone; remaining source groups, region operations and full differential comparison pending |
