...
| `src/brep/sweep.rs` | `cadkernel::brep::sweep` | 3802 | 4602 | 35 | in-progress | `brep_sweep.dl`; extrusion implementation and verification started; remaining sweep/rotation/taper/region operations pending |
...
| `src/geom2d/mod.rs` | `cadkernel::geom2d` | 170 | 187 | 2 | in-progress | `geometry2.dl` ellipse/tolerance verified with intersect2; complete module exports await curve layer |
