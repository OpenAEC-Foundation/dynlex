...
The earlier two-cuboid differential remains a regression check. The analytic
append extension now covers cylindrical surfaces; see
`tests/cadkernel/acis_append_analytic/README.md`.
...
NURBS geometry and pcurves, sparse arenas and full source behavior remain
outside this native append route. This is in-memory SAT record construction,
not a file parser or writer.
