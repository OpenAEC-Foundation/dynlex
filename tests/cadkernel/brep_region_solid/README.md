...
root count, cap-ring counts, and unchanged borrowed profiles. Empty, outside,
intersecting, touching, and nested holes are refused. Run it at O0 and O2 with:
...
additionally compares thirteen solid-region cases alongside lateral sheets. The
tests cover `extrude_region`; tapered solids, revolved regions and path sweeps
