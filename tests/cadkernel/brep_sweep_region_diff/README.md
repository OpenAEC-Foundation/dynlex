...
`extrude_surface_region_tapered`, and `extrude_region` operations with their
native DynLex counterparts.
...
The 34 cases include two and three independent sheets, solid regions with one
or two holes, circle splitting, closed-polyline splitting, full and segmented
arcs, oblique and reversed directions, negative taper, and empty, crossing,
touching, nested, and collapsed inputs. The verifier checks the pinned
...
All 34 cases pass at O0 and O2: 6,078 numeric field comparisons with exact
