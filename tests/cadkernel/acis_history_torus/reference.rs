...
use acadrust::objects::{SolidHistoryNodeBase, SolidHistoryOperation, SolidHistoryTorus};
...
fn main() {
    ...
    let matrix = std::array::from_fn(|index| argument_number(&args, index + 3));
    let operation = SolidHistoryOperation::Torus(SolidHistoryTorus {
