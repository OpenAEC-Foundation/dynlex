...
"""Compare the public native straight-path sheet route with pinned Rust."""
...
CASE_FIELDS = 28
CASES = ("explicit-base", "default-base", "weighted-profile", "reverse-orientation", "initial-rotation", "analytic-line", "two-span-spline", "weighted-path", "reverse-line", "off-plane-base-spline", "off-plane-base-line")
...
def main() -> None:
    ...
    output = args.output or Path(tempfile.mkdtemp(prefix="brep-path-public-diff-", dir=ROOT / "build"))
