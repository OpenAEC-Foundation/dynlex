...
token bits. The required fixture also confirms that an unsupported curve is
...
The spherical and analytic differentials are in
`tests/cadkernel/acis_append_sphere/README.md` and
`tests/cadkernel/acis_append_analytic/README.md`. This is an in-memory append
operation, not a SAT/SAB parser or writer. NURBS geometry and pcurves, sparse
arenas and full source behavior remain open.
