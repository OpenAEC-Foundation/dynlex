...
`70ac6da7cf149cea6398a3d8829dd5e48b485b96`. It compares 85 complete
body, surface, curve, topology, provenance and sloped-cone trace lines from
Rust and DynLex at both O0 and O2. The Rust reference also checks partial-loss
behavior; the native entry point still refuses malformed inputs with an empty
body. Other conical topologies, elliptical edge curves, splines, pcurves and
