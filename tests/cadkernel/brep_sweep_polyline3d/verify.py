...
"""Compare native spatial sweeps with the pinned Rust implementation."""
...
EXPECTED_VALID = (1, 1, 1, 1, 1, 0, 0, 0, 0)
...
def main() -> None:
    ...
    output = args.output or Path(tempfile.mkdtemp(prefix="brep-spatial-diff-", dir=ROOT / "build"))
