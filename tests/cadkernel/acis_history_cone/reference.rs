...
use acadrust::objects::{SolidHistoryCone, SolidHistoryNodeBase, SolidHistoryOperation};
...
fn main() {
    ...
    let operation = SolidHistoryOperation::Cone(SolidHistoryCone {
        ...
        operation_major: 7,
        operation_minor: 3,
        base_x_radius: argument_number(&args, 1),
        base_y_radius: argument_number(&args, 2),
        top_radius: argument_number(&args, 3),
