...
float terrain_height_at_x_z_f32_f32(float x, float z)
{
    ...
    float tmp72 = 0.4799999892711639404296875;
    float tmp73 = _the_431negative_1of_34opposite_1of_3453value_f32(tmp72);
    float tmp74 = 0.449999988079071044921875;
    float uplift = smooth_transition_from_lower_to_upper_at_sample_f32_f32_f32(tmp73, tmp74, continental_fold);
    float tmp75 = 1.0;
    float tmp76 = 0.0350000001490116119384765625;
    float tmp77 = 0.310000002384185791015625;
    float tmp78 = 0.23999999463558197021484375;
    float tmp79 = left1_4321_43right_f32_f32(broken_wave, tmp78);
    float tmp80 = left1_4331_43right_f32_f32(crossing_wave, tmp79);
    float tmp81 = _the43_absolute_value_of_magnitude_f32(tmp80);
    float tmp82 = smooth_transition_from_lower_to_upper_at_sample_f32_f32_f32(tmp76, tmp77, tmp81);
    float erosion_channels = left1_4351_43right_f32_f32(tmp75, tmp82);
    float tmp83 = 1.5499999523162841796875;
    float alpine_mass = left1_4321_43right_f32_f32(folded_mass, tmp83);
    float tmp84 = 2.0;
    float tmp85 = 6.0;
    float tmp86 = left1_4321_43right_f32_f32(uplift, tmp85);
    float tmp87 = left1_4331_43right_f32_f32(tmp84, tmp86);
    float tmp88 = left1_4321_43right_f32_f32(mountain_ridge, tmp87);
    alpine_mass = left1_4331_43right_f32_f32(alpine_mass, tmp88);
    float tmp89 = left1_4321_43right_f32_f32(broken_wave, uplift);
    float tmp90 = 0.3400000035762786865234375;
    float tmp91 = left1_4321_43right_f32_f32(tmp89, tmp90);
    alpine_mass = left1_4331_43right_f32_f32(alpine_mass, tmp91);
    float tmp92 = left1_4321_43right_f32_f32(erosion_channels, uplift);
    float tmp93 = 0.1599999964237213134765625;
    float tmp94 = 0.37999999523162841796875;
    float tmp95 = left1_4321_43right_f32_f32(mountain_ridge, tmp94);
    float tmp96 = left1_4331_43right_f32_f32(tmp93, tmp95);
    float tmp97 = left1_4321_43right_f32_f32(tmp92, tmp96);
    alpine_mass = left1_4351_43right_f32_f32(alpine_mass, tmp97);
    float tmp98 = 1.2000000476837158203125;
    float basin = left1_4321_43right_f32_f32(continental_fold, tmp98);
    float tmp99 = left1_4331_43right_f32_f32(basin, alpine_mass);
    float tmp100 = 0.75;
    return left1_4351_43right_f32_f32(tmp99, tmp100);
}
...
void main()
{
    ...
    {
        vec4 _404 = vec4(0.0);
        _404.y = in_Position.y;
        _404.x = in_Position.x;
        dynlex_interpolant_7465727261696e5f706f736974696f6e = _404;
        ...
        vec4 _410 = vec4(0.0, 0.0, 0.99989998340606689453125, 1.0);
        _410.y = in_Position.y;
        _410.x = in_Position.x;
        gl_Position = _410;
    }
    else
    {
        ...
        float tmp116 = 0.5;
        vec4 _382 = vec4(0.0, 0.0, 0.0, 1.0);
        _382.z = world_z;
        _382.y = displaced_height;
        _382.x = world_x;
        dynlex_interpolant_7465727261696e5f706f736974696f6e = _382;
        vec4 _389 = vec4(0.0);
        _389.w = view_distance;
        _389.z = normal_z;
        _389.y = normal_y;
        _389.x = normal_x;
        dynlex_interpolant_7465727261696e5f6e6f726d616c = _389;
        vec4 _393 = vec4(0.0);
        _393.y = left1_4331_43right_f32_f32(tmp115, tmp116);
        _393.x = left1_4331_43right_f32_f32(tmp106, tmp107);
        dynlex_interpolant_7465727261696e5f6d6174657269616c = _393;
        vec4 _396 = vec4(0.0);
        _396.w = view_z;
        _396.z = left1_4351_43right_f32_f32(tmp97, tmp98);
        _396.y = left1_4371_43right_f32_f32(view_y, tmp95);
        _396.x = left1_4371_43right_f32_f32(lateral_distance, tmp94);
        gl_Position = _396;
    }
}
