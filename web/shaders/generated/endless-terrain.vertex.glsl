...
void main()
{
    ...
    {
        vec4 _530 = vec4(0.0);
        _530.y = in_Position.y;
        _530.x = in_Position.x;
        dynlex_interpolant_7465727261696e5f706f736974696f6e = _530;
        ...
        vec4 _536 = vec4(0.0, 0.0, 0.99989998340606689453125, 1.0);
        _536.y = in_Position.y;
        _536.x = in_Position.x;
        gl_Position = _536;
    }
    else
    {
        ...
        float _474 = 0.0;
        float _475 = 0.0;
        if (left_2_right_f32_f32(surface_vertex, tmp78))
        {
            float tmp79 = 0.62000000476837158203125;
            float water_level = _the_431negative_1of_34opposite_1of_3453value_f32(tmp79);
            float tmp80 = 0.17000000178813934326171875;
            float tmp81 = left1_4321_43right_f32_f32(world_x, tmp80);
            float tmp82 = 0.070000000298023223876953125;
            float tmp83 = left1_4321_43right_f32_f32(world_z, tmp82);
            float tmp84 = left1_4331_43right_f32_f32(tmp81, tmp83);
            float tmp85 = 0.4099999964237213134765625;
            float tmp86 = left1_4321_43right_f32_f32(time, tmp85);
            float water_angle_x = left1_4331_43right_f32_f32(tmp84, tmp86);
            float tmp87 = 0.20999999344348907470703125;
            float tmp88 = left1_4321_43right_f32_f32(world_z, tmp87);
            float tmp89 = 0.0500000007450580596923828125;
            float tmp90 = left1_4321_43right_f32_f32(world_x, tmp89);
            float tmp91 = left1_4351_43right_f32_f32(tmp88, tmp90);
            float tmp92 = 0.319999992847442626953125;
            float tmp93 = left1_4321_43right_f32_f32(time, tmp92);
            float water_angle_z = left1_4351_43right_f32_f32(tmp91, tmp93);
            float tmp94 = 0.0900000035762786865234375;
            float tmp95 = left1_4321_43right_f32_f32(world_x, tmp94);
            float tmp96 = 0.12999999523162841796875;
            float tmp97 = left1_4321_43right_f32_f32(world_z, tmp96);
            float tmp98 = left1_4331_43right_f32_f32(tmp95, tmp97);
            float tmp99 = 0.23000000417232513427734375;
            float tmp100 = left1_4321_43right_f32_f32(time, tmp99);
            float water_angle_cross = left1_4331_43right_f32_f32(tmp98, tmp100);
            ...
            float tmp101 = 0.04500000178813934326171875;
            float tmp102 = left1_4321_43right_f32_f32(water_wave_x, tmp101);
            float tmp103 = 0.0280000008642673492431640625;
            float tmp104 = left1_4321_43right_f32_f32(water_wave_z, tmp103);
            float tmp105 = left1_4331_43right_f32_f32(tmp102, tmp104);
            float tmp106 = left1_4331_43right_f32_f32(water_level, tmp105);
            float tmp107 = 0.017999999225139617919921875;
            float tmp108 = left1_4321_43right_f32_f32(water_wave_cross, tmp107);
            displaced_height = left1_4331_43right_f32_f32(tmp106, tmp108);
            float tmp109 = _the43_cosine_of_value_f32(water_angle_x);
            float tmp110 = 0.007650000043213367462158203125;
            float tmp111 = left1_4321_43right_f32_f32(tmp109, tmp110);
            float tmp112 = _the43_cosine_of_value_f32(water_angle_cross);
            float tmp113 = 0.00161999999545514583587646484375;
            float tmp114 = left1_4321_43right_f32_f32(tmp112, tmp113);
            float tmp115 = left1_4331_43right_f32_f32(tmp111, tmp114);
            normal_x = _the_431negative_1of_34opposite_1of_3453value_f32(tmp115);
            float tmp116 = _the43_cosine_of_value_f32(water_angle_z);
            float tmp117 = 0.00588000006973743438720703125;
            float tmp118 = left1_4321_43right_f32_f32(tmp116, tmp117);
            float tmp119 = _the43_cosine_of_value_f32(water_angle_cross);
            float tmp120 = 0.00233999988995492458343505859375;
            float tmp121 = left1_4321_43right_f32_f32(tmp119, tmp120);
            float tmp122 = left1_4331_43right_f32_f32(tmp118, tmp121);
            normal_z = _the_431negative_1of_34opposite_1of_3453value_f32(tmp122);
            float tmp123 = left1_4331_43right_f32_f32(water_wave_x, water_wave_z);
            float tmp124 = 0.25;
            float tmp125 = left1_4321_43right_f32_f32(tmp123, tmp124);
            float tmp126 = 0.5;
            float tmp127 = 0.5;
            float tmp128 = left1_4321_43right_f32_f32(water_wave_cross, tmp127);
            float tmp129 = 0.5;
            _474 = left1_4331_43right_f32_f32(tmp128, tmp129);
            _475 = left1_4331_43right_f32_f32(tmp125, tmp126);
        }
        else
        {
            displaced_height = terrain_height_at_x_z_f32_f32(world_x, world_z);
            float tmp131 = left1_4331_43right_f32_f32(world_x, normal_step);
            float height_right = terrain_height_at_x_z_f32_f32(tmp131, world_z);
            float tmp132 = left1_4331_43right_f32_f32(world_z, normal_step);
            float height_front = terrain_height_at_x_z_f32_f32(world_x, tmp132);
            ...
            float tmp133 = 0.064999997615814208984375;
            float tmp134 = left1_4321_43right_f32_f32(world_x, tmp133);
            float tmp135 = 0.064999997615814208984375;
            float tmp136 = left1_4321_43right_f32_f32(world_z, tmp135);
            float tmp137 = 13.69999980926513671875;
            float tmp138 = simplex_field_at_x_y_phase_f32_f32_f32(tmp134, tmp136, tmp137);
            float tmp139 = 0.5;
            float tmp140 = left1_4321_43right_f32_f32(tmp138, tmp139);
            float tmp141 = 0.5;
            float tmp142 = 0.14000000059604644775390625;
            float tmp143 = left1_4321_43right_f32_f32(world_x, tmp142);
            float tmp144 = 0.14000000059604644775390625;
            float tmp145 = left1_4321_43right_f32_f32(world_z, tmp144);
            float tmp146 = 16.200000762939453125;
            float tmp147 = simplex_field_at_x_y_phase_f32_f32_f32(tmp143, tmp145, tmp146);
            float tmp148 = 0.5;
            float tmp149 = left1_4321_43right_f32_f32(tmp147, tmp148);
            float tmp150 = 0.5;
            _474 = left1_4331_43right_f32_f32(tmp149, tmp150);
            _475 = left1_4331_43right_f32_f32(tmp140, tmp141);
        }
        float tmp151 = left1_4321_43right_f32_f32(normal_x, normal_x);
        float tmp152 = left1_4321_43right_f32_f32(normal_y, normal_y);
        float tmp153 = left1_4331_43right_f32_f32(tmp151, tmp152);
        float tmp154 = left1_4321_43right_f32_f32(normal_z, normal_z);
        float tmp155 = left1_4331_43right_f32_f32(tmp153, tmp154);
        float normal_length = _the43_square_root_of_value_f32(tmp155);
        ...
        float tmp156 = 0.1550000011920928955078125;
        float tmp157 = 0.10999999940395355224609375;
        float tmp158 = left1_4321_43right_f32_f32(time, tmp157);
        float tmp159 = _the43_sine_of_value_f32(tmp158);
        float tmp160 = 0.01200000010430812835693359375;
        float tmp161 = left1_4321_43right_f32_f32(tmp159, tmp160);
        float camera_pitch = left1_4331_43right_f32_f32(tmp156, tmp161);
        ...
        float tmp162 = left1_4321_43right_f32_f32(vertical_distance, pitch_cosine);
        float tmp163 = left1_4321_43right_f32_f32(view_distance, pitch_sine);
        float view_y = left1_4331_43right_f32_f32(tmp162, tmp163);
        float tmp164 = left1_4321_43right_f32_f32(view_distance, pitch_cosine);
        float tmp165 = left1_4321_43right_f32_f32(vertical_distance, pitch_sine);
        float view_z = left1_4351_43right_f32_f32(tmp164, tmp165);
        float tmp166 = 0.7200000286102294921875;
        float tmp167 = left1_4321_43right_f32_f32(aspect, tmp166);
        float tmp168 = 0.7200000286102294921875;
        float tmp169 = 1.0033400058746337890625;
        float tmp170 = left1_4321_43right_f32_f32(view_z, tmp169);
        float tmp171 = 0.400669991970062255859375;
        vec4 _507 = vec4(0.0);
        _507.w = surface_vertex;
        _507.z = world_z;
        _507.y = displaced_height;
        _507.x = world_x;
        dynlex_interpolant_7465727261696e5f706f736974696f6e = _507;
        vec4 _515 = vec4(0.0);
        _515.w = view_distance;
        _515.z = normal_z;
        _515.y = normal_y;
        _515.x = normal_x;
        dynlex_interpolant_7465727261696e5f6e6f726d616c = _515;
        vec4 _519 = vec4(0.0);
        _519.y = _474;
        _519.x = _475;
        dynlex_interpolant_7465727261696e5f6d6174657269616c = _519;
        vec4 _522 = vec4(0.0);
        _522.w = view_z;
        _522.z = left1_4351_43right_f32_f32(tmp170, tmp171);
        _522.y = left1_4371_43right_f32_f32(view_y, tmp168);
        _522.x = left1_4371_43right_f32_f32(lateral_distance, tmp167);
        gl_Position = _522;
    }
}
