...
struct IntrinsicInfo {
	...
	constexpr IntrinsicInfo(int minArgCount, IntrinsicReturnKind returnKind, IntrinsicKind kind)
		: minArgCount(minArgCount), maxArgCount(minArgCount), returnKind(returnKind), kind(kind) {}

	constexpr IntrinsicInfo(int minArgCount, int maxArgCount, IntrinsicReturnKind returnKind, IntrinsicKind kind)
...
#define DYNLEX_INTRINSIC_REG_ENTRY_FIXED(kind, name, minArgCount, returnKind)                                                  \
	{name, {minArgCount, returnKind, IntrinsicKind::kind}},
